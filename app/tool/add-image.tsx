            ...
            {loading ? (
              ...
              <View className="bg-[#1C1C1E] border border-[#2C2C2E] rounded-2xl p-5 mb-5">
                ...
                {!imageUri ? (
                  <Pressable
                    onPress={pickImage}
                    className="w-full bg-[#0A0A0A] border border-[#2C2C2E] rounded-xl py-4 flex-row items-center justify-center mb-5 active:bg-[#161618]"
                  >
                    <GalleryIcon />
                  ...
                  <View className="mb-5 relative w-full aspect-[4/3] bg-[#0A0A0A] rounded-xl overflow-hidden border border-[#2C2C2E] items-center justify-center">
                    <Image source={{ uri: imageUri }} className="w-full h-full" resizeMode="contain" />
                    <Pressable
                      onPress={pickImage}
                      className="absolute bottom-3 right-3 bg-black/75 px-4 py-2 rounded-xl border border-[#2C2C2E]"
                    >
                      ...
                      {(['small', 'medium', 'large'] as const).map((sz) => (
                        <Pressable
                          ...
                          className={`flex-1 h-full items-center justify-center ${
                            imgSizePreset === sz ? 'bg-[#FF3B30]' : 'active:bg-[#1C1C1E]'
                          }`}
                        >
                          <Text
                            className={`font-black text-[10px] uppercase ${
                              imgSizePreset === sz ? 'text-white' : 'text-[#9C9CA3]'
                            }`}
                          >
