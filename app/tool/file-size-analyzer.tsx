              ...
              <>
                ...
                <View className="flex-row items-center mb-6" style={{ gap: 12 }}>
                  ...
                  <View className="flex-1" style={{ gap: 2 }}>
                    <Text className="text-[#9C9CA3] text-[10px] font-black uppercase tracking-wider">
                      Document Size
                    </Text>
                    <Text className="text-white text-3xl font-extrabold">
                      {formatSize(fileSize)}
                    </Text>
                    <Text className="text-[#9C9CA3] text-xs font-semibold mt-0.5">
                ...
                >
                  ...
                  <Text className="text-[#9C9CA3] text-xs leading-relaxed">
                    {diag.desc}
                  </Text>
                </View>

                {/* Structure details */}
                <View className="bg-[#1C1C1E] border border-[#2C2C2E] rounded-2xl p-5 mb-6">
                  <Text className="text-white text-base font-bold mb-4">
                    PDF Structure Details
                  </Text>
                  
                  <View className="flex-row justify-between mb-3.5 pb-3 border-b border-[#2C2C2E]/60">
                    <Text className="text-[#9C9CA3] text-xs font-bold">Document Engine</Text>
                    <Text className="text-white text-xs font-bold" numberOfLines={1}>{producerText}</Text>
                  </View>

                  <View className="flex-row justify-between mb-3.5 pb-3 border-b border-[#2C2C2E]/60">
                    <Text className="text-[#9C9CA3] text-xs font-bold">Metadata Overhead</Text>
                    <Text className="text-white text-xs font-bold">{hasMetadata ? 'Minimal (~2 KB)' : 'None'}</Text>
                  </View>

                  <View className="flex-row justify-between">
                    <Text className="text-[#9C9CA3] text-xs font-bold">Average Size Per Page</Text>
                ...
                <View className="flex-row gap-3">
                  <Pressable
                    onPress={pickFile}
                    className="flex-1 bg-[#1C1C1E] border border-[#2C2C2E] py-4 rounded-xl items-center active:bg-[#2C2C2E]"
                  >
