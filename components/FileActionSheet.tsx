...
export default function FileActionSheet({
    ...
    const strokeColor = isDark ? '#fff' : '#1C1C1E';
    ...
    const menuActions = [
        {
            ...
            icon: (
                <Svg width="22" height="22" viewBox="0 0 24 24">
                    <G fill="none" stroke={strokeColor} strokeLinejoin="round" strokeWidth="1.5">
        ...
        },
        {
            ...
            icon: (
                <Svg width="22" height="22" viewBox="0 0 24 24">
                    <G fill="none" stroke="#FF3B30" strokeLinecap="round" strokeWidth="1.5">
                        <Path d="m19.5 5.5l-.402 6.506M4.5 5.5l.605 10.025c.154 2.567.232 3.85.874 4.774c.317.456.726.842 1.2 1.131c.671.41 1.502.533 2.821.57" />
                        <Path strokeLinejoin="round" d="m20 15l-7 7m7 0l-7-7" />
                        <Path d="M3 5.5h18m-4.944 0l-.683-1.408c-.453-.936-.68-1.403-1.071-1.695a2 2 0 0 0-.275-.172C13.594 2 13.074 2 12.035 2c-1.066 0-1.599 0-2.04.234a2 2 0 0 0-.278.18c-.395.303-.616.788-1.058 1.757L8.053 5.5" />
                    </G>
                </Svg>
            ),
        },
                ...
                <View className="bg-white dark:bg-[#2e2e2e] border-t border-[#E5E5EA] dark:border-[#2C2C2E] rounded-t-[32px] px-6 pb-12">
                    ...
                    <View className="mb-6 flex-row items-center" style={{ gap: 14 }}>
                        ...
                        <View className="flex-1">
                            <Text className="text-lg font-bold text-[#1C1C1E] dark:text-white" numberOfLines={1}>
                                {file.name}
                            </Text>
                            <Text className="text-xs font-semibold text-[#8E8E93] dark:text-[#9C9CA3] mt-1">
                        ...
                        {menuActions.map((action) => (
                            ...
                            >
                                ...
                                <Text
                                    ...
                                    style={{ color: action.key === 'delete' ? '#FF3B30' : (isDark ? '#FFFFFF' : '#1C1C1E') }}
                                >
                                    {action.label}
                                </Text>
                            </Pressable>
                    ...
                    <Pressable
                        onPress={onClose}
                        className="bg-[#F2F2F7] dark:bg-[#1C1C1E] mt-3 py-4 rounded-2xl items-center active:opacity-80 border border-[#E5E5EA] dark:border-[#2C2C2E]"
                    >
                        <Text className="text-[#8E8E93] dark:text-[#9C9CA3] text-sm font-bold">Cancel</Text>
                    </Pressable>
                </View>
            </View>
        </Modal>
